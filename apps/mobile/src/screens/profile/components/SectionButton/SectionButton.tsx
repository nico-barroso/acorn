...
import LockIcon from '../../assets/profile-password-icon.svg';
import LogOut from '../../assets/profile-logout-icon.svg';
import WarningIcon from '@/assets/icons/profile-exclamation-triangle.svg';
import BellIcon from '../../assets/profile-bell-icon.svg';
